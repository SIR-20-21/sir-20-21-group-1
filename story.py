    ...
    def __init__(self, interactive : bool = True):
        ...
        if interactive:
            self.story = {
                ...
                "d28": Storypart(id="d28", content_type="storypart", content="I was looking on the top shelves behind the clothes for some useful clues.", movement="point_up-d42859/behavior_1", movement_type=MOVEMENT_TYPE.GESTURE, follow_id="d29"),
                ...
                "d31a": Storypart(id="d31a", content_type="storypart", content="No unfortunately that is not correct, but still a very good try. {0}", follow_id="d34"),
                "d31b": Storypart(id="d31b", content_type="storypart", content="Very good! The correct answer is indeed green.", movement="clapping-ed52d2/behavior_1", movement_type=MOVEMENT_TYPE.GESTURE, follow_id="d34"),
                ...
                #START ROOM SCENE
                "d53": Storypart(id="d53", content_type="storypart", content="Via the window I entered my bedroom, where I was sleeping just an hour ago", soundfile="sounds/sleep.wav", follow_id="d54"),
                "d54": Storypart(id="d54", content_type="storypart", content="I walked straight to my hamsters cage to see how my old hamster Hamtaro was doing", follow_id="d55"),
                "d55": Storypart(id="d55", content_type="storypart", content="I opened the cage and I looked directly into the feeding bowl, was it possible that he ate my bananas?", soundfile="sounds/mouse.wav", movement="mouse_motion-3bf9b6/behavior_1", movement_type=MOVEMENT_TYPE.GESTURE, follow_id="d56"),
                ...
                "d57b": Storypart(id="d57b", content_type="storypart", content="That’s correct!", movement="animations/Stand/Exclamation/NAO/Right_Strong_EXC_03", movement_type=MOVEMENT_TYPE.GESTURE, follow_id="d59"),

                # grabbing movement below removed
                "d59": Storypart(id="d59", content_type="storypart", content="I grabbed Hamtaro and looked at him", follow_id="d60a"),
                "d60a": Storypart(id="d60a", content_type="storypart", content="Hamtaro was half the size of a banana, he couldn’t be the one who ate all my bananas", follow_id="d60b"),
                "d60b": Storypart(id="d60b", content_type="storypart", content="Also the cage was closed when I arrived", follow_id="d60c"),
                "d60c": Storypart(id="d60c", content_type="storypart", content="I started to look further around in my room, but I detected nothing suspicious", follow_id="d62"),
                #END ROOM SCENE
            
                #START ATTIC SCENE 

                "d62": Storypart(id="d62", content_type="storypart", content="Then I looked up and saw the rope that leads to the attic, also known as my secret hiding spot and investigation headquarters", movement="point_up-d42859/behavior_1", movement_type=MOVEMENT_TYPE.GESTURE, follow_id="d63"),
                ...
                "d68": Storypart(id="d68", content_type="storypart", content="I turned on the lights and in front of me I saw a very big and hairy monkey with some weird disco trousers on.", soundfile="sounds/monkey.wav", movement='gorilla_motion-3ce914/behavior_1', movement_type=MOVEMENT_TYPE.GESTURE, follow_id="d69"),
